...
![](images/lesson01/fig1a.jpg){height=60%}
...
+ Society faces an important trade-off between \textbf{\color{blue} efficiency vs. equity (equality) }:
  ...
  - \textbf{Equity:}  when prosperity is distributed uniformly or *fairly* among society's members
...
![](images/lesson01/fig2.jpg){height=60%}
...
![](images/lesson01/fig3.jpg){height=50%}
...
## \textbf{Principle 10:} Society Faces a Short-run Tradeoff Between Inflation and Unemployment
